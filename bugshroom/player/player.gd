...
#
#@onready var root_state_machine : AnimationNodeStateMachinePlayback = animation_tree["parameters/RootStateMachine/playback"]
#
...
#func toggle_root():
	#if animation_tree["parameters/Blend2/blend_amount"] == 0:
		#animation_tree["parameters/Blend2/blend_amount"] = 1
	#is_rooted = !is_rooted
	#if is_rooted:
		#root_state_machine.travel("crouch")
		...
		#
	#else:
		#root_state_machine.travel("uncrouch")
		##animation_tree["parameters/Oneshot_Crouch/request"] = AnimationNodeOneShot.ONE_SHOT_REQUEST_FIRE
	...
	#if animation_tree["parameters/Blend2/blend_amount"] == 1:
...
@onready var animation_tree : AnimationTree = $PlayerModel/AnimationTreeStateMachine
@onready var animation_player: AnimationPlayer = $PlayerModel/AnimationPlayer
@onready var camera_mount = $CameraMount
@onready var camera_yaw = $CameraMount/CameraYaw
@onready var camera_pitch = $CameraMount/CameraYaw/CameraPitch
...
func _ready() -> void:
	...
	animation_tree["parameters/conditions/is_stopped"] = true
...
func take_damage(amount):
	animation_tree["parameters/take_damage/OneShot/request"] = AnimationNodeOneShot.ONE_SHOT_REQUEST_FIRE
	current_health -= amount
	health_bar.update()
	if current_health <= 0 and !is_dead:
		die()
...
func toggle_root():
	is_rooted = !is_rooted
	if is_rooted:
		animation_tree["parameters/conditions/is_rooted"] = true
	else:
		animation_tree["parameters/conditions/is_rooted"] = false
